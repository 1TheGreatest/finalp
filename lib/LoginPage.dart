...
class LoginPageState extends State<LoginPage> with TickerProviderStateMixin {
    ...
    if (validateAndSave()){
      ...
      try{
        ...
        if (_formType == FormType.login){
          ...
          String userId = await widget.auth.createUserWithEmailAndPassword(_username,_phnumber,_email,_password,_cpassword);
  ...
  void validateAndSubmitSign() async {

    if (validateAndSaveSign()){
  ...
  _addNewUser(String usernameItem, String phoneItem, String emailItem ) {
              ...
              Container(
                ...
                child: new Material(
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: validateAndSubmitSign,
                    child: Text("Sign In",
